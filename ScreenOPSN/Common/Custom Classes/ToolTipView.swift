...
class TooltipView: UIView {
    ...
    // Orientation methods
    private func topLeft(_ width: CGFloat, _ height: CGFloat) -> CGPoint {
        return CGPoint(x: width, y: height)
    }
    private func topRight(_ width: CGFloat, _ height: CGFloat) -> CGPoint {
        return CGPoint(x: CGFloat(tooltipWidth) - width, y: height)
    }
    private func bottomLeft(_ width: CGFloat, _ height: CGFloat) -> CGPoint {
        return CGPoint(x: width, y: CGFloat(tooltipHeight) - height)
    }
    private func bottomRight(_ width: CGFloat, _ height: CGFloat) -> CGPoint {
        return CGPoint(x: CGFloat(tooltipWidth) - width, y: CGFloat(tooltipHeight) - height)
    }
    // Draw methods
